        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="dropdown dropdown-notifications">
                    <a href="#notifications-panel" id="notification-button" class="dropdown-toggle" data-toggle="dropdown">
                        <i data-count="0" id="icon_count" class="glyphicon glyphicon-bell notification-icon"></i>
                    </a>
...
<script>
    var btnNotification = $('#notification-button');
    btnNotification.click(function () {
        var count  = $('#icon_count').data("count");
